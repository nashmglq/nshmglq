...
import { FlipWords } from "@/components/footer-card";
...
function NashPortfolio() {
  return (
    <div className="bg-black">
      ...
      {/* Education */}
      <div className="flex bg-black text-white items-center justify-center w-full flex-col px-4 py-16">
        ...
        <div className=" container mx-auto p-4 w-full md:w-1/2 justify-center">
          {Data.educations.map((education, index) => (
            <div className="flex flex-wrap mt-2 bg-[#222222] rounded-md p-2 items-center" key={index}>
